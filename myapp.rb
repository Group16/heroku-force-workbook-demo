...
class MyApp < Sinatra::Base
  ...
  get '/' do
    logger.info "Visited home page"
     ...
     @accounts3 = clienttt.query("SELECT owner.name from event where owner.title in ('cloud services engineer','cloud service engineer','Cloud Services Architect','Technical Incident Engineer - vCHS','Technical Incident Engineer - vCloud','Cloud Services Engineer',' Technical Support Engineer') and startdatetime>=#{d}T00:00:00.000Z and enddatetime<=#{d}T10:01:00.000Z and showas = 'busy' and (owner.userroleid = '00E80000001bNmA' or owner.userroleid = '00E80000001bNmy')")
     @accounts4 = clientttt.query("SELECT owner.name from event where owner.title in ('Cloud Services Engineer','Consulting Cloud Architect - vCloud Air','Cloud Service Engineer','Technical Incident Engineer') and startdatetime>=#{d}T12:59:00.000Z and enddatetime<=#{d}T:31:01.000Z and showas = 'busy' and owner.userroleid = '00E80000001bNmj'")
