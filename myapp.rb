...
class MyApp < Sinatra::Base
  ...
  get '/' do
    logger.info "Visited home page"
     ...
     @accounts3 = clienttt.query("SELECT owner.name from event where owner.title in ('Technical Incident Engineer - vCHS','Technical Incident Engineer - vCloud','Cloud Services Engineer',' Technical Support Engineer') and startdatetime>=#{d}T10:59:00.000Z and enddatetime<=#{d}T21:01:00.000Z and showas = 'busy' and owner.userroleid = '00E80000001bNmy'")
