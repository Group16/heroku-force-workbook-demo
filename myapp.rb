...
class MyApp < Sinatra::Base
  ...
  get '/' do
    logger.info "Visited home page"
     ...
     @accounts2 = clientt.query("SELECT owner.name from event where owner.title in ('cloud services engineer','cloud service engineer') and startdatetime>=#{d}T07:29:00.000Z and enddatetime<=#{d}T17:01:00.000Z and showas = 'busy'")
    erb :index
  end
